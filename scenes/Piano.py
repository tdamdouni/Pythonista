...
# https://www.reddit.com/r/Python/comments/1vwdx4/pythonista_its_more_powerful_than_you_think/
...
class Piano (Scene): 
	def setup(self): 
		self.white_keys = [] 
		self.black_keys = []
		white_key_names = ['Piano_C3', 'Piano_D3', 'Piano_E3', 'Piano_F3', 'Piano_G3', 'Piano_A3', 'Piano_B3', 'Piano_C4']
		black_key_names = ['Piano_C3#', 'Piano_D3#', 'Piano_F3#', 'Piano_G3#', 'Piano_A3#'] 
