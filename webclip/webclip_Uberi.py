...
# https://gist.github.com/Uberi/5031803/

# https://gist.github.com/pudquick/4130373

# URL is automatically opened in Safari (safari-http feature in 1.3)
# Currently open file is used (now you can add it to the actions menu)
# Script name is URL encoded to fix bugs where name had spaces and such
