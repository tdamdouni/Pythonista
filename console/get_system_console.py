...
# https://github.com/lukaskollmer/pythonista-scripts/blob/master/System-Console/get_system_console.py

# https://forum.omz-software.com/topic/3338/share-code-access-pythonistas-system-log
