# https://gist.github.com/git-bee/63facc327131e1931161
...
class clock(Scene):
	...
	def draw(self):
		...
		# draw them all
		self.draw_time(self.n)
		#self.draw_date(n)
		
	def touch_ended(self, touch):
		self.quartz = not self.quartz
		t = 'saat ini pukul %02d %02d'
		ngomong(t % (self.n.hour, self.n.minute))
		
run(clock(),DEFAULT_ORIENTATION,1,True)
