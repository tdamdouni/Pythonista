# https://gist.github.com/anonymous/19e99d748397855003afdebf32dafc3a
...
v2 = AnalogClock(frame=(0,300,200,200), timezone='Europe/Berlin')
v3 = AnalogClock(frame=(300,0,200,200), timezone='America/New_York')
v4 = AnalogClock(frame=(300,300,200,200), timezone='Asia/Bangkok')
v.add_subview(v1)
v.add_subview(ui.Label(text='local time', alignment=ui.ALIGN_CENTER, frame=(0,220,200,50)))
v.add_subview(v2)
v.add_subview(ui.Label(text='Berlin time', alignment=ui.ALIGN_CENTER, frame=(0,520,200,50)))
v.add_subview(v3)
v.add_subview(ui.Label(text='Newyork time', alignment=ui.ALIGN_CENTER, frame=(300,220,200,50)))
v.add_subview(v4)
v.add_subview(ui.Label(text='Bangkok time', alignment=ui.ALIGN_CENTER, frame=(300,520,200,50)))
v.present('sheet')
