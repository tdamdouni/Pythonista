...
# https://forum.omz-software.com/topic/4162/which-version-of-pythonista-is-this-code/2

# scene.Rect isn’t subclassable anymore, and that ui.View.did_load has a slightly different behavior. 

# patched pixel_editor.py
