# https://github.com/Mr-Coxall/Git2Go-to-Pythonista/blob/master/Git2Go_to_Pythonista.py
...
def main():
    ...
    if appex.is_running_extension():
        ...
        full_files_destination = file_picker_dialog('Pick some directory to place file in.', multiple=True, select_dirs=True, file_pattern=r'^.*\.py$')
        ...
        short_path = ('~/Documents'+files_destination[1]+'/'+file_name_alone)
        #print(short_path)
        ...
        if unique_filename != filename:
            ...
            try:
                alert_response = console.alert('You will overwrite\n' + short_path + '\n\nAre you sure?','','Yes')
