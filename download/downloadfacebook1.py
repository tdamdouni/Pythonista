...
# https://gist.github.com/anonymous/29ca31b52689d9c0ce99781097a7fe1b
...
def DownloadFacebookVideo(url, title_length):
        ...
        for i, text in enumerate(title_list):
            if item == text:
                ...
                if video_quality != None:
                    ...
                    #dialogs.alert('Downloading ' + fname + '...')
                    fname = 'temp.mp4'
                    #DownloadFile(vq_list[video_quality], fname)
...
def main():
    ...
    fname = DownloadFacebookVideo(url, 35)
